...
inline int pthread_cond_timedwait(pthread_cond_t *c, pthread_mutex_t *m, struct timespec *t)
{
...
typedef int pthread_condattr_t;
inline int pthread_condattr_destroy(pthread_condattr_t *a)
{
	(void) a;
	return 0;
}
...
inline int pthread_condattr_init(pthread_condattr_t *a)
{
	*a = 0;
	return 0;
}

inline int pthread_condattr_getpshared(pthread_condattr_t *a, int *s)
{
	*s = *a;
	return 0;
}

inline int pthread_condattr_setpshared(pthread_condattr_t *a, int s)
{
	*a = s;
	return 0;
}
