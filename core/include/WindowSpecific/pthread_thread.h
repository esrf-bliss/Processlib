...
DWORD _pthread_tls;
inline int _pthread_once_raw(pthread_once_t *o, void (*func)(void))
{
  long state = *o;
...
inline void pthread_tls_init(void)
{
...
inline void _pthread_cleanup_dest(pthread_t t)
{
  int i, j;
...
inline int pthread_get_concurrency(int *val)
{
  *val = _pthread_concur;
  return 0;
}

inline int pthread_set_concurrency(int val)
{
  _pthread_concur = val;
  return 0;
}
...
inline unsigned _pthread_get_state(pthread_attr_t *attr, unsigned flag)
{
  return attr->p_state & flag;
}

inline int _pthread_set_state(pthread_attr_t *attr, unsigned flag, unsigned val)
{
...
inline int pthread_attr_setdetachstate(pthread_attr_t *a, int flag)
{
  return _pthread_set_state(a, PTHREAD_CREATE_DETACHED, flag);
}

inline int pthread_attr_getdetachstate(pthread_attr_t *a, int *flag)
{
  *flag = _pthread_get_state(a, PTHREAD_CREATE_DETACHED);
  return 0;
}

inline int pthread_attr_setinheritsched(pthread_attr_t *a, int flag)
{
  return _pthread_set_state(a, PTHREAD_INHERIT_SCHED, flag);
}

inline int pthread_attr_getinheritsched(pthread_attr_t *a, int *flag)
{
  *flag = _pthread_get_state(a, PTHREAD_INHERIT_SCHED);
  return 0;
}

inline int pthread_attr_setscope(pthread_attr_t *a, int flag)
{
  return _pthread_set_state(a, PTHREAD_SCOPE_SYSTEM, flag);
}

inline int pthread_attr_getscope(pthread_attr_t *a, int *flag)
{
  *flag = _pthread_get_state(a, PTHREAD_SCOPE_SYSTEM);
  return 0;
}

inline int pthread_attr_getstackaddr(pthread_attr_t *attr, void **stack)
{
  *stack = attr->stack;
  return 0;
}

inline int pthread_attr_setstackaddr(pthread_attr_t *attr, void *stack)
{
  attr->stack = stack;
  return 0;
}

inline int pthread_attr_getstacksize(pthread_attr_t *attr, size_t *size)
{
  *size = attr->s_size;
  return 0;
}

inline int pthread_attr_setstacksize(pthread_attr_t *attr, size_t size)
{
  attr->s_size = size;
  return 0;
}
...
inline int pthread_setcanceltype(int type, int *oldtype)
{
  pthread_t t = pthread_self();
...
inline unsigned int pthread_create_wrapper(void *args)
{
