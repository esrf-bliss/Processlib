...
#            Position = self.File.tell()
    ...
    def _WriteImage (self, Header, Data, Append=1, DataType="", ByteOrder=""):
        ...
        self.Images[Index].StaticHeader["Image"] = "%d" % (Index + 1)
        self.Images[Index].StaticHeader["HeaderID"] = "EH:%06d:000000:000000" % (Index + 1)
        ...
        StrHeader = StrHeader.ljust(int(newsize))
        StrHeader = StrHeader + "}\n"
...
def GetDefaultNumpyType(EdfType):
    ...
    """
    EdfType = EdfType.upper()
    if   EdfType == "SIGNEDBYTE":       return numpy.int8   # ""
