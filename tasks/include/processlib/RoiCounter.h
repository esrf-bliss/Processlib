...
struct PROCESSLIB_EXPORT RoiCounterResult
{
    ...
    explicit RoiCounterResult(RoiCounterManager::ErrorCode code) : errorCode(code) {}
...
class PROCESSLIB_EXPORT RoiCounterTask : public SinkTask<RoiCounterResult>
{
  public:
    ...
    void setArcMask(double centerX, double centerY, double rayon1, double rayon2, double angle_start, double angle_end);
    void getArcMask(double &centerX, double &centerY, double &rayon1, double &rayon2, double &angle_start,
                    double &angle_end);
  ...
  private:
    ...
    typedef struct ArcRoi
    {
        ...
        ArcRoi(double dx, double dy, double dr1, double dr2, double da1, double da2)
            : x(dx), y(dy), r1(dr1), r2(dr2), a1(da1), a2(da2)
        {
        }
        bool isSet() { return (r1 != 0) || (r2 != 0) || (a1 != 0) || (a2 != 0); }
    } ArcRoi;
